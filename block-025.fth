vhere const ctrl-cases
  ...
  key-end  case mv-end         key-cend  case mv-end!
  key-home case mv-home        key-chome case mv-home!
  key-pgup case next-blk       key-pgdn  case prev-blk
  key-del  case delete-char    key-ins   case insert-toggle
  13 case mv-cr    9 case mv-tab-r    17 case mv-tab-l    24 case delete-prev
  3  case normal-mode!                end-cases
